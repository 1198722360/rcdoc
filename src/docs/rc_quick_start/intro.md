...
<div class="intro-section">
  <div class="intro-card">
    ...
    <div class="intro-content">
      ...
      <p>此前我们是做 ChatGPT 的 Web 端镜像的，运营两年，克服了降智、封号等一系列棘手的问题，积累了无数逆向相关的经验以及技术，并有一套稳定的 ChatGPT、Claude、Grok 网关。</p>
  ...
  <div class="pricing-cards">
    <div class="pricing-card">
      ...
      <div class="card-features">
        ...
        <div class="feature-item">
          ...
          <span>每日 30$ + <span class="highlight-text">转结剩余</span></span>
        </div>
      </div>
    </div>
    <div class="pricing-card popular">
      ...
      <div class="card-features">
        ...
        <div class="feature-item">
          <iconify-icon icon="mdi:cash-multiple" width="16" height="16"></iconify-icon>
          <span>每日 60$ + <span class="highlight-text">转结剩余</span></span>
        </div>
      </div>
    </div>
    <div class="pricing-card">
      ...
      <div class="card-features">
        ...
        <div class="feature-item">
          <iconify-icon icon="mdi:cash-multiple" width="16" height="16"></iconify-icon>
          <span>每日 90$ + <span class="highlight-text">转结剩余</span></span>
        </div>
      </div>
    </div>
  </div>
